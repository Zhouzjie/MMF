...
class FlickrDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        image_rcnn = self.get_rcnn(os.path.join(feature_path, path))  # return img-feature 100 2048 & pos-feature
        ...
        caption.append(vocab('<end>'))
        target = torch.Tensor(caption)
        return image_rcnn, image, target, index, img_id
...
def collate_fn(data):
    ...
    image_rcnn, images, captions, ids, img_ids = zip(*data)
    ...
    return image_rcnn, images, targets, lengths, ids
